<?php
// ini untuk mengambil semua yang dikirimkan oleh "homeSentitems.php" setelah tombol filter diklik 
				...
				<div class="col s12 collapsible-body" style="margin-top:30px;">
					<form action="" method="POST" name="filterSentitems">
						...
						<div class="input-field col s3" style="margin-bottom:20px">
							...
							<?php
								// menampilkan semua user yang ada untuk dipilih & men'select' user yang sudah dipilih sebelumnya
